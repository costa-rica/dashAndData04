...
file_handler = logging.FileHandler(os.path.join(logs_dir,'bls.log'))
...
def blsIndustry():
    ...
    if request.method=="POST":
        ...
        if addSeries_id:
            ...
            bls_folder_path = os.path.join(current_app.config['STATIC_PATH'],'utility_bls')
            ...
            excelObj.close()
            return send_from_directory(os.path.join(bls_folder_path,'blsIndustryPPI.xlsx', as_attachment=True))
